...
describe('Delete complement', () => {
  ...
  it('should be able to delete a complement', async () => {
    ...
    const response = await request(app).delete(`/complements/${id}`).set('Authorization', `Bearer ${token}`);
  ...
  it('should not be able to delete a complement without a token', async () => {
    const response = await request(app).delete(`/complements/${v4()}`);
  ...
  it('should not be able to delete a complement with a invalid token', async () => {
    const response = await request(app).delete(`/complements/${v4()}`).set('Authorization', `Bearer invalid.token`);
  ...
  it('should not be able to delete a non-existing complement', async () => {
    const response = await request(app).delete(`/complements/${v4()}`).set('Authorization', `Bearer ${token}`);
