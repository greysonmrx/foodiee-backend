...
describe('Create product', () => {
  ...
  it('should not be able to create a new product without a token', async () => {
    const response = await request(app).post(`/products/${v4()}`).send({
      name: 'Pizza de peperone',
      description: 'Uma pizza muito saborosa com os melhores ingredientes do mercado.',
      price: 80.5,
      promotion_price: 60,
  ...
  it('should not be able to create a new product with a invalid token', async () => {
    const response = await request(app)
      .post(`/products/${v4()}`)
      .send({
        name: 'Pizza de peperone',
  ...
  it('should not be able to create a new product with no name', async () => {
    const response = await request(app)
      .post(`/products/${v4()}`)
      .send({
        description: 'Uma pizza muito saborosa com os melhores ingredientes do mercado.',
  ...
  it('should not be able to create a new product without a description', async () => {
    const response = await request(app)
      .post(`/products/${v4()}`)
      .send({
        name: 'Pizza de peperone',
  ...
  it('should not be able to create a new product without a price', async () => {
    const response = await request(app)
      .post(`/products/${v4()}`)
      .send({
        name: 'Pizza de peperone',
  ...
  it('should not be able to create a new product with a invalid price', async () => {
    const response = await request(app)
      .post(`/products/${v4()}`)
      .send({
        name: 'Pizza de peperone',
  ...
  it('should not be able to create a new product with a invalid promotion price', async () => {
    const response = await request(app)
      .post(`/products/${v4()}`)
      .send({
        name: 'Pizza de peperone',
  ...
  it('should not be able to create a new product without a category id', async () => {
    const response = await request(app)
      .post(`/products/${v4()}`)
      .send({
        name: 'Pizza de peperone',
  ...
  it('should not be able to create a new product with a invalid category id', async () => {
    const response = await request(app)
      .post(`/products/${v4()}`)
      .send({
        name: 'Pizza de peperone',
  ...
  it('should not be able to create a new product with a invalid image id', async () => {
    const response = await request(app)
      .post(`/products/${v4()}`)
      .send({
        name: 'Pizza de peperone',
  ...
  it('should not be able to create a new product with a invalid paused value', async () => {
    const response = await request(app)
      .post(`/products/${v4()}`)
      .send({
        name: 'Pizza de peperone',
  ...
  it('should not be able to create a new product with a invalid tenant id', async () => {
    const response = await request(app)
      .post(`/products/invalid-tenant-id`)
      .send({
        name: 'Pizza de peperone',
        description: 'Uma pizza muito saborosa com os melhores ingredientes do mercado.',
        price: 80.5,
